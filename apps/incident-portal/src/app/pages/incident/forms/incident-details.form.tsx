      ...
      <VStack w="100%" spacing={6} mb="6" alignItems="flex-start">
            ...
            <Alert status="info" rounded={5} p={6} maxW="600px">
              ...
              <Box ml={1}>
                ...
                <AlertDescription>
                  ...
                  products, please enter a valid CityFibre service reference (S
                  ref) to activate this
                </AlertDescription>
              </Box>
              <CloseButton
            ...
            {status === "active" && !isLoading && (
              ...
              >
                ...
                <Box ml={1}>
                  ...
                  <AlertDescription>
                    Our last status check was that the line is up, please check
              ...
              >
                ...
                <Box ml={1}>
                  ...
                  <AlertDescription>
                    ...
                    incident and provide as much of the requested information as
                    possible
                  </AlertDescription>
                </Box>
              </Alert>
        ...
        <SimpleGrid columns={2} spacing={6} w="100%">
          ...
          <FormItem label="Postcode">
            <Input name="postcode" placeholder="Enter Postcode" maxW="600px" />
          </FormItem>
          <FormItem label="City">
        ...
        <FormItem>
          <Checkbox name="confirm" size="lg">
            <Text fontSize="16px" pl="2">
              I confirm I have completed the required triage as per the MSA and
              that I may be liable for any engineering costs that occur due to
              my non-compliance
            </Text>
          </Checkbox>
        </FormItem>
