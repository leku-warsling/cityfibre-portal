...
export const sizes = () => (
  <VStack spacing="4">
    ...
    <Text fontSize="5xl">4xl Text</Text>
...
export const truncation = () => (
  <VStack spacing={4} w="500">
    <Text noOfLines={1}>
      ...
      venenatis purus a tincidunt viverra. Maecenas at nunc at orci fringilla
      interdum vel nec ante. Suspendisse a convallis dolor, vitae semper nisl
    </Text>
    <Text noOfLines={3}>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sit amet
      egestas nisi. Cras vestibulum posuere semper. Vivamus in imperdiet orci.
